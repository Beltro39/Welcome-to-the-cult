...
public class BuyResources : MonoBehaviour
{
    ...
    public void Begin(PlayerClass PlayerClass){
        ...
        Itilianos= PlayerClass.getItilianos();
        Juniors= PlayerClass.getListEmployees().getJuniors();
        SemiSeniors= PlayerClass.getListEmployees().getSemiSeniors();
        Seniors= PlayerClass.getListEmployees().getSeniors();
        Architects= PlayerClass.getListEmployees().getArchitects();
        Servers= PlayerClass.getListTechnologies().getServers();
        Satellites= PlayerClass.getListTechnologies().getSatellites();
        IA= PlayerClass.getListTechnologies().getIA();
        Hosting= PlayerClass.getListTechnologies().getHosting(); 
