...
namespace Lean.Gui
{
	...
	public class LeanDrag : LeanSelectable, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		public UnityEvent OnBegin { get { if (onBegin == null) { onBegin = new UnityEvent(); } return onBegin; } } [SerializeField] public UnityEvent onBegin;

		/// <summary>This allows you to perform an actions when this element ends being dragged.</summary>
		public UnityEvent OnEnd { get { if (onEnd == null) { onEnd = new UnityEvent(); } return onEnd; } } [SerializeField] public UnityEvent onEnd;
